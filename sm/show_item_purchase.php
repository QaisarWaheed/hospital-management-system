...
<tr>
	...
	<td>'.$batch_no.'</td>
	<td>'.$warrantee.'</td>
	<td>'.($mfg_date && $mfg_date != '0000-00-00' && $mfg_date != '0000-00-00 00:00:00' ? date_format(date_create($mfg_date), "d-m-y") : ''.'</td>
...
<!-- 
 -->($expiry_date && $expiry_date != '0000-00-00' && $expiry_date != '0000-00-00 00:00:00' ? date_format(date_create($expiry_date), "d-m-y") : ''.'</td>
	<td>'.$quantity.'</td>
	<td>'.$status_msg.' IN '.$tries.' TRY </td>
	<td title="Medicine Maganer">'.$mm_name.'</td>
	<td title="Store Maganer">'.$sm_name.'</td>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
<!-- 
 -->($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created), "d-m-Y") : ''; ?></div>
    </caption>    
