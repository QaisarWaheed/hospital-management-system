...
<div class = "container">
    <table class = "table table-bordered">
            ...
            <caption style = "text-align: center;caption-side: top;color: black;">
                ...
                <H3>EMPLO($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
            ...
            <caption style = "text-align: center;caption-side: top;color: black;">
                <h2>YOUTH COMMUNITY DEVELOPMENT ORGANIZATION</h2>
                <H3>EMPLO($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
