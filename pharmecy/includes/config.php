...
function show_to_doctors_by_token_id($token_id)
{
    ...
    if (mysqli_num_rows($run1) == 1)  
    {
        while ($row1 = mysqli_fetch_array($run1)) 
        {
            ...
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $r($row1['out_time'] && $row1['out_time'] != '0000-00-00' && $row1['out_ti($row1['out_time'] && $row1['out_time'] != '0000-00-00' && $row1['out_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['out_time']), "h:i:s A") : '';
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $row1['phone'];
...
function show_to_doctors_by_token_id($token_id)
{
    ...
    if (mysqli_num_rows($run1) == 1)  
    {
        while ($row1 = mysqli_fetch_array($run1)) 
        {
            ...
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $r($row1['out_time'] && $row1['out_time'] != '0000-00-00' && $row1['out_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['out_time']), "h:i:s A") : '';
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $row1['phone'];
...
function show_to_doctors_by_token_id($token_id)
{
    ...
    if (mysqli_num_rows($run1) == 1)  
    {
        while ($row1 = mysqli_fetch_array($run1)) 
        {
            ...
            $consultant_name = $row1['u_name'];
            $consultant_in_time = date_format(date_create($row1['in_time']), "h:i:s A");
            $consultant_out_time ($row1['in_time'] && $row1['in_time'] != '0000-00-00' && $row1['in_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['in_time']), "h:i:s A") : '';
            $consultant_out_time = date_format(date_create($row1['out_time']), "h:i:s A");
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
...
?>($row1['in_time'] && $row1['in_time'] != '0000-00-00' && $row1['in_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['in_time']), "h:i:s A") : '';
            $consultant_out_time = date_format(date_create($row1['out_time']), "h:i:s A");
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phon($row1['out_time'] && $row1['out_time'] != '0000-00-00' && $row1['out_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['out_time']), "h:i:s A") : '';
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $r($row1['out_time'] && $row1['out_time'] != '0000-00-00' && $row1['out_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['out_time']), "h:i:s A") : '';
...
?>($row1['in_time'] && $row1['in_time'] != '0000-00-00' && $row1['in_time'] != '0000-00-00 00:00:00' ? date_format(date_create($row1['in_time']), "h:i:s A") : '';
            ...
            $output .= ' <span style="font-size:10px;">&nbsp; <i class="fa fa-drivers-license" style="font-size:10px;color:green"></i> '.$consultant_qualification.'</span></br>';
            $output .= ' &nbsp; <i class="fa fa-hand-o-right" style="font-size:16px;color:green;"></i>'.$row1['name'].'</br> '.$row1['address'].'</br>';
            $output .= ' &nbsp; <i class="fa fa-envelope" style="font-size:16px;color:green"></i> <i class="fa fa-phone-square" style="font-size:16px;colo$row1['out_time']), "h:i:s A") : '';
            $consultant_qualification = $row1['qualification'];
            // $consultant_qualification = str_replace(',', '</br>&nbsp;&nbsp;<i class="fa fa-file-text" style="font-size:16px;color:green"></i>',$row1['qualification']);
            if($consultant_qualification == ''){$consultant_qualification = "OPD STAFF";}
            $consultant_phone = $row1['phone'];
