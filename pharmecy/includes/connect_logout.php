...
if (mysqli_num_rows($get_selected_medicines) > 0) {
    while ($row_selected_medicines = mysqli_fetch_array($get_selected_medicines)) {
        ...
        if ($feed == 1) {   $feed_urdu = 'ایک';}
        elseif ($feed == 2) {   $feed_urdu = 'دو';}
        elseif ($feed == 3) {   $feed_($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
...
td,th,tr,table {    border-top: 1px solid black;    border-collapse: collapse;}
td.description, th.description {    width: 220px;    max-width: 220px;font-weight: 900;}
td.quantity, th.quantity {   ($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td class="quantity">Name:</td>
        <td class="description">'.$name.'</td>
...
td,th,tr,table {    border-top: 1px solid black;    border-collapse: collapse;}
td.description, th.description {    width: 220px;    max-width: 220px;font-weight: 900;}
td.quantity, th.quantity {    width: 100px;    m$created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
