...
<html>
<head>
    <title><?php echo htmlspecialchars(get_branch_tag_by($br_id), ENT_QUOTES, 'UTF-8'); ?> <?php echo ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), 'm-Y') : ''; ?> MONTHLY PROGRESS REPORT</title>
</head>
<body>
...
($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
    ...
    <tbody>
<?php
if ($run && mysqli_num_rows($run) > 0($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th>S#</th>
