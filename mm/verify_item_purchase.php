            ...
            <table class = "table">
                <thead>
                    <tr>
                        ...
                        <th>BATCH</th>
                        <th>MFG</th>
                        <th>E($to && $to != '0000-00-00' && $to != '($to && $to != '0000-00-00' && $to != '0000-00-00 00:00:00' ? date_format(date_create($to), "Y-m-d 23:59:59") : '';
?>
        <div class=""> 
        <div id="divID">
            <table class = "table">
                <thead>
                    <tr>
                        ...
                        <th>BATCH</th>
                        <th>MFG</th>
                        <th>E($to && $to != '0000-00-00' && $to != '0000-00-00 00:00:00' ? date_format(date_create($to), "Y-m-d 23:59:59") : '';
?>
        <div class=""> 
        <div id="divID">
            <table class = "table">
...
?>
                    ...
                    echo '
                    <tr>
                        <td colspan = "10">'.$con->err$to), "Y-m-d 23:59:59") : '';
?>
        <div class=""> 
        <div id="divID">
            <table class = "table">
