...
?>
<script>
window.open("print_summary.php?s=<?php echo $from_date; ?>&e=<?php echo $to_date; ?>&u=<?php echo $user_id_s; ?>&un=<?php echo $user_name_s; ?>", "_blank", "toolbar=no,scrollbars=no,resizable=no,top=50,left=50,status=no");
