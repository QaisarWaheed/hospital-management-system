...
$select = "SELECT * FROM tokans WHERE 
	...
	`created` >($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-00 00:00:00' ? date_format(date_create($to_date), 'd-m-Y') : ''; ?></span></div>
...
$select = "SELECT * FROM tokans WHERE 
	`created` <= '$last_date' AND 
	`created` >($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-00 00:00:00' ? date_format(date_create($to_date), 'd-m-Y') : ''; ?></span></div>
...
$users = "SELECT * FROM `summary_details` WHERE login_id IN (SELE$to_date), 'd-m-Y') : ''; ?></span></div>
