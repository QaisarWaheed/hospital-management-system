...
</html>    ($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['created'] != '0000-00-00 00:00:00' ? date_format(date_create($row_token['created']), "d-m-Y") : '';
                        $s++;
                    echo '
                    <tr>
                        <td>'.$s.'</td>
