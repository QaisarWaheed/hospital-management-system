...
<?php mysqli_close($con); ?>($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            ...
            <tr>
                ...
                <td><?php echo $other_person_name; ?></td>
                <th>PHONE</th>
                <td><?php echo $other_person_phone; ?></td>($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
