...
{
    if(isset($_POST['br_id']) != ''){$br_id = $_POST['br_id'];}
    ...
    VALUES
    (NULL, '".substr(date('Y-m-d H:i:s'),0,7)."', '".substr(date('Y-m-d H:i:s'),8)."', '$employee_id', '$attendance_record_title', '$attendance_record_remarks', '".substr(date('Y-m-d H:i:s'),11)."', '1', '$current_date', '$hr_id', '$br_id', '$staff_time_in', '$staff_time_out')";
