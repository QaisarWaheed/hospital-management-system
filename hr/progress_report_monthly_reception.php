...
if( isset($_POST['date']) && $_POST['date'] != '')
{
    $date = $_POST['date'];
    $br_id = $_POST['br_id'];
    echo '<script>window.open("../bk/print_progess_report_monthly_reception.php?date='.$date.'&br_id='.$br_id.'", "PROGRESS RECEPTION REPORT", "width=3000,height=3000");</script>';
}
?>
	<title>MONTHLY(GYNAE) PROGRESS - <?php echo $company_trademark; ?></title>
        ...
        <div class = "row">
            <div class = "col">
                ...
                <select name = "br_id" class = "form-control" required>
                    ...
                    <?PHP
                    $branch = "SELECT * FROM branchs WHERE id != '$hr_branch_id' AND status = '1' ORDER BY `address` ASC ";
