...
<body onafterprint="window.location.href = 'show_staff.php'">
    ...
    <table class = "table table-bordered">
            ...
            <tr>
                <th>DUTY START</th>
                <td><?php echo ($staff_time_in && $staff_time_in != '0000-00-00' && $staff_time_in != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_in), "h:i A") : ''; ?></td>
                <th>DUTY END</th>
...
<?php mysqli_close($con); ?>($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
<?php mysqli_close($con); ?>($staff_time_out && $staff_time_out != '0000-00-00' && $staff_time_out != '0000-00-00 00:00:00' ? date_format(date_create($staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
            ...
            <tr>
                ...
                <td><?php echo date_format(date_create($staff_joining_date), "d-M-Y"); ?></td>
                <td>BASIC SALARY</td>
                <td><?php echo $staff_($staff_joining_date && $staff_joining_date != '0000-00-00' && $staff_joining_date != '0000-00-00 00:00:00' ? date_format(date_create($staff_joining_date), "d-M-Y") : ''; ?></td>
                <td>BASIC SALARY</td>
                <td><?php echo $staff_bacis_salary; ?></td>
                <td>ALLOW LEAVE</td>
                <td><?php echo $staff_allowed_leaves; ?></td>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
<?php mysqli_close($con); ?>($staff_joining_date && $staff_joining_date != '0000-00-00' && $staff_joining_date != '0000-00-00 00:00:00' ? date_format(date_create($staff_joining_date), "d-M-Y") : ''; ?></td>
                <td>BASIC SALARY</td>
                <td><?php echo $staff_bacis_salary; ?></td>
                <td>ALLOW LEAVE</td>
                <td><?php echo $staff_allowed_leaves; ?></td>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
<?php mysqli_close($con); ?>$staff_time_out), "h:i A") : ''; ?></td>
            </tr>
            <tr>
                <th>DUTY HOURS</th> 
                <td><?php echo $staff_duty_hours; ?></td>
...
<script type="text/javascript" src="js/bootstrap.min.js"></script>
<?php mysqli_close($con); ?>$staff_joining_date), "d-M-Y") : ''; ?></td>
                <td>BASIC SALARY</td>
                <td><?php echo $staff_bacis_salary; ?></td>
                <td>ALLOW LEAVE</td>
                <td><?php echo $staff_allowed_leaves; ?></td>
