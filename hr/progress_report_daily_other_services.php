...
if( isset($_POST['date']) && $_POST['date'] != '')
{
    $date = $_POST['date'];
    $br_id = $_POST['br_id'];
    echo '<script>window.open("../bk/print_progess_report_daily_other_services.php?date='.$date.'&br_id='.$br_id.'", "OTHER SERVICES PROGRESS REPORT", "width=3000,height=3000");</script>';
}
?>
	<title>DAILY(OTHER SERVICES) PROGRESS - <?php echo $company_trademark; ?></title>
