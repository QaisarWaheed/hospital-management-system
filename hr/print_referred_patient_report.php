...
if($br_id > 0)
{
    $select_referral_token = "SELECT * FROM `referral_patients` WHERE branch_id = '$br_id' AND opd_token_id > 0 AND referral_patient_status > 0 AND referral_patient_created LIKE '$date%' AND referral_patient_status = '2' ORDER BY branch_id, referral_patient_status ";
}
else
{
