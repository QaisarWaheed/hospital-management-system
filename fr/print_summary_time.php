...
<table class="table" style="font-size: 10px">
	...
	<tr style="caption-side: top;text-align: center;">
    	...
    	<h5>Token Summary</h5>
         ...
         <div style="float:left"><strong>Date:</strong><span style="text-align: left;"><?php echo date_format(date_create($from_date), 'd-m-Y h:i:s A'); ?> To <?php echo date_format(date_create($to_date), 'd-m-Y h:i:s A'); ?></span></div>
