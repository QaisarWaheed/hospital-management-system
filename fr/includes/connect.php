...
$output .=  '<h1 style = "font-size: 25px;" align="center"> '.$id.' / '.date('y').'</h1>
    ...
    <tr>
        ...
        <td class="description">'.($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
...
function get_branch_item_id_from_select_by_doctor_id($id)
{
  ...
  ($created && $created != '0000-00-00' && $created !($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
...
function get_branch_item_id_from_select_by_doctor_id($id)
{
  ...
  ($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
...
?>($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created), "m:h:i A d-M-Y") : ''.'</span></h3>
    </caption>';
    }
}
$select_audit = mysqli_query($GLOBALS['con'], "SELECT * FROM branch_audits WHERE audit_no = '$branch_audit_no' ");
...
function print_medicine_slip($id)
{
    ...
    if (mysqli_num_rows($run) == 1) 
    {
        while ($row = mysqli_fetch_array($run)) 
        {
            ...
            $tokan_type_id = $row['tokan_type_id'];
            $get_tokan_type = mysqli_query($GLOBALS['con'], "SELECT * FROM tokan_types WHERE id = '$tokan_type_id' ");
            if (mys($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created), "m:h:i A d-M-Y") : ''.'</span></h3>
    </caption>';
    }
}
$select_audit = mysqli_query($GLOBALS['con'], "SELECT * FROM branch_audits WHERE audit_no = '$branch_audit_no' ");
