...
?>
<script>
window.open("print_summary_time.php?s=<?php echo $from_date; ?>&e=<?php echo $to_date; ?>&u=<?php echo $user_id_s; ?>&un=<?php echo $user_name_s; ?>&br_id=<?php echo $br_id; ?>", "_blank", "toolbar=no,scrollbars=no,resizable=no,top=50,left=50,status=no");
	  location.replace("user_summary_time.php");
window.close();
</script>
<?php
}
		...
		<form method="GET"  target="_blank">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					...
					<input type="datetime-local" name="from_date" class="form-control" required id="from_date">
				
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6">

					<label for="to_date">To:</label>
					<input type="datetime-local" name="to_date" class="form-control" required id="to_date">
