...
{
$select = "SELECT * FROM tokans WHERE 
	`branch_id` = ($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-00 00:00:00' ? date_format(date_create($to_date), 'd-m-Y') : ''; ?></span></div>
...
{
$select = "SELECT * FROM tokans WHERE 
	`branch_id` = ($to_date && $to_date != '0000-00-00' && $to_date != '0000-00-00 00:00:00' ? date_format(date_create($to_date), 'd-m-Y') : ''; ?></span></div>
...
if (mysqli_num_rows($run) > 0) 
{
	while ($row = mysqli_fetch_array($run)) 
	{
		...
		($token_date && $token_date != '0000-00-00' && $token_date != '0000-00-00 00:00:00' ? date_format(date_create($token_date), "h:i A") : ''.'</td>
			<td>'.date_format(date_create($token_date), "d M").'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
...
if (mysqli_num_rows($run) > 0) 
{
	...
	{
		$tokan_type_id = $row['tokan_type_id'];
			$select_count = "SELECT * FROM tokans WHE($token_date && $token_date != '0000-00-00' && $token_date != '0000-00-00 00:00:00' ? date_format(date_create($token_date), "h:i A") : ''.'</td>
			<td>'.date_format(date_create($token_date), "d M").'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
...
if (mysqli_num_rows($run) > 0) 
{
    ...
    $receive_tokens = '';
    $receive = "SELECT * FROM `branch_pending_receive` WHERE`branch_id` = '$br_id' AND status = '1' AND `created` <= '$last_date' AN($token_date && $($token_date && $token_date != '0000-00-00' && $token_date != '0000-00-00 00:00:00' ? date_format(date_create($token_date), "d M") : ''.'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
			<td style="text-align: right;">'.$age.'</td>
...
if (mysqli_num_rows($run) > 0) 
{
    ...
    $pending_receive_amount = 0;
    $receive_tokens = '';
    $receive = "SELECT * FROM `branch_pending_receive` WHERE`branch_id` = '$br_id' AND status = '1' AND `created` <= '$last_date' AN($token_date && $token_date != '0000-00-00' && $token_date != '0000-00-00 00:00:00' ? date_format(date_create($token_date), "d M") : ''.'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
			<td style="text-align: right;">'.$age.'</td>
	...
	while ($row = mysqli_fetch_array($run)) 
	{
		$tokan_type_id = $row['tokan_type_id'];
			$select_count = "SELECT * FROM tokans WHERE 
				user_id = '$u_id' AND 
				`created` <= '$last_date' AND 
				`created` >= '$from_date' AND to$token_date), "h:i A") : ''.'</td>
			<td>'.date_format(date_create($token_date), "d M").'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
...
if (mysqli_num_rows($run) > 0) 
{
	...
	{
		$tokan_type_id = $row['tokan_type_id'];
			$select_count = "S($token_date && $token_date != '0000-00-00' && $token_date != '0000-00-00 00:00:00' ? date_format(date_create($token_date), "d M") : ''.'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
			<td style="text-align: right;">'.$age.'</td>
            ...
            $token_no = $row_pending['token_no'];
                ...
                if(mysqli_num_rows($run_token) == 1)
                {
                    while($row_token = mysqli_fetch_array($run_token))
                    {
                        ...
                        $token_by = get_uname_by_id($ro$token_date), "d M") : ''.'</td>
			<td style="text-align: right;">'.$row['id'].'</td>
			<td>'.$name.'('.$genders.')</td>
			<td>'.$phone.'</td>
			<td style="text-align: right;">'.$age.'</td>
