                ...
                <div class = "panel-body">
                    <table class = "table table-bordered table-sm">
                        ...
                        <tr>
                            ...
                            <th><?php echo $lab.' -> '.number_format($lab_amount); ?></th>
                            <th><?php echo $svd.' -> '.number_format($svd_amount); ?></th>
                            <th><?php echo $dnc.' -> '.number_format($dnc_amount); ?></th>
                            <th><?php echo $operation.' -> '.number_format($operation_amount); ?></th>
                            <th><?php echo number_format($collection); ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <th><?php echo $lab_2.' -> '.number_format($lab_amount_2); ?></th>
                            <th><?php echo $svd_2.' -> '.number_format($svd_amount_2); ?></th>
                            <th><?php echo $dnc_2.' -> '.number_format($dnc_amount_2); ?></th>
                            <th><?php echo $operation_2.' -> '.number_format($operation_amount_2); ?></th>
                            <th><?php echo number_format($collection_2); ?></th>
                        </tr>
                        <tr>
                            <th>Differance</th>
                            ...
                            <th><?php echo number_format($svd-$svd_2).' -> '.number_format($svd_amount-$svd_amount_2); ?></th>
                            <th><?php echo number_format($dnc-$dnc_2).' -> '.number_format($dnc_amount-$dnc_amount_2); ?></th>
                            <th><?php echo number_format($operation-$operation_2).' -> '.number_format($operation_amount-$operation_amount_2); ?></th>
                            <th><?php echo number_format($collection-$collection_2); ?></th>
                        </tr>
        <?php
        $opd = 0;
        $consultant_opd = 0;
