	...
	<div class="col-md-12">
        ...
        if(mysqli_num_rows($run_query) > 0)
        {
            while($row_query = mysqli_fetch_array($run_query) )
            {
                ...
                <tr>
                    <td>'.$s.'</td>
                    <td style = "text-align: center;">'.($token_at && $token_at != '0000-00-00' && $token_at != '0000-00-00 00:00:00' ? date_format(date_create($token_at), "d-F-Y") : ''.'</td>
...
</html>($token_at && $token_at != '0000-00-00' && $token_at != '0000-00-00 00:00:00' ? date_format(date_create($token_at), "h:i:s A") : ''.'</td>
                    <td>'.$token_by.'</td>
                    <td>'.$token_return_by.'</td>
                    <td>'.date_format(date_create($token_return_at), "h:i:s A").'</td>
                    <td>'.$bra_address.'</td>
...
</html>($token_return_at && $token_return_at != '0000-00-00' && $token_return_at != '0000-00-00 00:00:00' ? date_format(date_create($token_return_at), "h:i:s A") : ''.'</td>
                    <td>'.$bra_address.'</td>
                    <td style = "text-align: center;">'.number_format((float)($cash ?? 0)).'</td>
                    <td style = "text-align: center;">'.number_format((float)($cash_received ?? 0)).'</td>
                </tr>
...
</html>$token_return_at), "h:i:s A") : ''.'</td>
                    <td>'.$bra_address.'</td>
                    <td style = "text-align: center;">'.number_format((float)($cash ?? 0)).'</td>
                    <td style = "text-align: center;">'.number_format((float)($cash_received ?? 0)).'</td>
                </tr>
