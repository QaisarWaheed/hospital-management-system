...
$output .= '
    <caption style="caption-side: top;text-align: center;">
        ...
        <h3>Date And Time : <span>'.($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created), "m:h:i A d-M-Y") : ''.'</span></h3>
    </caption>';
    }
}
    ...
    while ($row_selected_medicines = mysqli_fetch_array($get_selected_medicines)) {
        ...
        if (mysqli_num_rows($get_feed_str) > 0) 
        {
            while ($row_feed_str = mysqli_fetch_array($get_feed_str)) 
            {
                ...
                elseif($feed_cat_id  >= 7 && $feed_cat_id  <= 11)
                {
                $feed_title = 'بار لگ($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
    ...
    while ($row_selected_medicines = mysqli_fetch_array($get_selected_medicines)) {
        ...
        if (mysqli_num_rows($get_feed_str) > 0) 
        {
            while ($row_feed_str = mysqli_fetch_array($get_feed_str)) 
            {
                ...
                elseif($feed_($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
    ...
    while ($row_selected_medicines = mysqli_fetch_array($get_selected_medicines)) {
        ...
        if (mysqli_num_rows($get_feed_str) > 0) 
        {
            while ($row_feed_str = mysqli_fetch_array($get_feed_str)) 
            {
                ...
                if($feed_cat_id  == 1)
                {
                $feed_title = 'گولی/گو($created && $created != '0000-00-00' && $created != '0000-00-00 00:00:00' ? date_format(date_create($created),'d-M-Y h:i:s A') : ''.'</td>
    </tr>
    <tr>
        <td>Name:</td>
        <td>'.$name.'</td>
