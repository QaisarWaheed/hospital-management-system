                ...
                <div class = "row">
                    <div class = "col" style  = "text-align: center;">
                        ...
                        for($i=1; $i<=$total; $i++)
                        {
                            ...
                            {
                                echo '<a href = "lg_operate_pending.php?br_id='.$br_id.'&from_date='.$from_date.'&to_date='.$_GET['to_date'].'&page_no='.$i.'" class = "btn btn-sm btn-info" style = "margin: 2px($_GET['to_date'] && $_GET['to_date'] != '0000-00-00' && $_GET($_GET['to_date'] && $_GET['to_date'] != '0000-00-00' && $_GET['to_date'] != '0000-00-00 00:00:00' ? date_format(date_create($_GET['to_date']), 'Y-m-d') : '';}else{echo date('Y-m-d');} ?>" id = "to_date" class = "form-control" required />
	                        </div>
	                        <div class = "col-md-2" style  = "text-align: center;">
	                            <input type = "submit" value = "SEARCH" name = "submit" style  = "min-width: 100%;min-height: 100%;" id = "submit" class = "btn btn-sm btn-info" />
	                        </div>
                ...
                <div class = "row">
                    <div class = "col" style  = "text-align: center;">
                        ...
                        for($i=1; $i<=$total; $i++)
                        {
                            ...
                            {
                                echo '<a href = "lg_operate_pending.php?br_id='.$br_id.'&from_date='.$from_date.'&to_date='.$_GET['to_date'].'&page_no='.$i.'" class = "btn btn-sm btn-info" style = "margin: 2px($_GET['to_date'] && $_GET['to_date'] != '0000-00-00' && $_GET['to_date'] != '0000-00-00 00:00:00' ? date_format(date_create($_GET['to_date']), 'Y-m-d') : '';}else{echo date('Y-m-d');} ?>" id = "to_date" class = "form-control" required />
	                        </div>
	                        <div class = "col-md-2" style  = "text-align: center;">
	                            <input type = "submit" value = "SEARCH" name = "submit" style  = "min-width: 100%;min-height: 100%;" id = "submit" class = "btn btn-sm btn-info" />
	                        </div>
                ...
                <div class = "row">
                    <div class = "col" style  = "text-align: center;">
                        ...
                        for($i=1; $i<=$total; $i++)
                        {
                            ...
                            {
                                echo '<a href = "lg_operate_pending.php?br_id='.$br_id.'&from_date='.$from_date.'&to_date='.$_GET['to_date'].'&page_no='.$i.'" class = "btn btn-sm btn-info" style = "margin: 2px;">'.$i.'</a>'$_GET['to_date']), 'Y-m-d') : '';}else{echo date('Y-m-d');} ?>" id = "to_date" class = "form-control" required />
	                        </div>
	                        <div class = "col-md-2" style  = "text-align: center;">
	                            <input type = "submit" value = "SEARCH" name = "submit" style  = "min-width: 100%;min-height: 100%;" id = "submit" class = "btn btn-sm btn-info" />
	                        </div>
