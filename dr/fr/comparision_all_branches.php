...
?>
<script>
    window.open("print_comparision.php?s=<?php echo $first_month; ?>&e=<?php echo $second_month; ?>", "_blank", "toolbar=no,scrollbars=no,resizable=no,top=50,left=50,status=no");
