...
if(mysqli_num_rows($run_branch) > 0)
{
    while($row_branch = mysqli_fetch_array($run_branch))
    {
        ...
        // PATIENT FIRST MONTH
        $patient_first_month = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `tokans` WHERE `status` = 1 AND `branch_id` = '$comparision_branch_($second_month && $second_month != '0000-00-00' && $second_month != ($second_month && $second_month != '0000-00-00' && $second_month != '0000-00-00 00:00:00' ? date_format(date_create($second_month), "F Y") : ''; ?></h1></label>
        </div>
<?php
$select_branch = "SELECT * FROM `branchs` WHERE `status` = 1 ";
$run_branch = mysqli_query($con, $select_branch);
if(mysqli_num_rows($run_branch) > 0)
{
    while($row_branch = mysqli_fetch_array($run_branch))
    {
        ...
        // PATIENT FIRST MONTH
        $patient_first_month = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `tokans` WHERE `status` = 1 AND `branch_id` = '$comparision_branch_($second_month && $second_month != '0000-00-00' && $second_month != '0000-00-00 00:00:00' ? date_format(date_create($second_month), "F Y") : ''; ?></h1></label>
        </div>
<?php
$select_branch = "SELECT * FROM `branchs` WHERE `status` = 1 ";
$run_branch = mysqli_query($con, $select_branch);
if(mysqli_num_rows($run_branch) > 0)
{
    while($row_branch = mysqli_fetch_array($run_branch))
    {
        ...
        $cons_first_month = mysqli_num_rows(mysqli_query($con, "SELECT `tokan_no` FROM `item_by_doctor` W$second_month), "F Y") : ''; ?></h1></label>
        </div>
<?php
$select_branch = "SELECT * FROM `branchs` WHERE `status` = 1 ";
$run_branch = mysqli_query($con, $select_branch);
                ...
                <div class = "panel-body">
                    <table class = "table table-bordered">
                        ...
                        <tr>
                            ...
                            <th><?php echo $patient_second_month; ?> + <?php echo $cons_second_month; ?> => <?php echo intval($pati($first_month && $first_month != '0000-00-00' && $first_month != '0000-00-00 00:00:00' ? date_format(date_create($first_month), "M-y") : ''; ?></th>
                            <th><?php echo $patient_first_month; ?> + <?php echo $cons_first_month; ?> => <?php echo intval($patient_first_month+$cons_first_month); ?></th>
                            <th><?php echo $lab_first_month; ?></th>
                            <th><?php echo $select_procedure; ?></th>
                            <th><?php echo $collection_first_month; ?></th>
                        ...
                        <tr>
                            <th><?php echo date_format(date_create($second_month), "M-y"); ?></th>
                            <th><?php echo $patient_second_month; ?> + <?php echo $cons_second_month; ?> => <?php echo intval($patient_se($first_month && $first_month != '0000-00-00' && $first_month != '0000-00-00 00:00:00' ? date_format(date_create($first_month), "M-y") : ''; ?></th>
                            <th><?php echo $patient_first_month; ?> + <?php echo $cons_first_month; ?> => <?php echo intval($patient_first_month+$cons_first_month); ?></th>
                            <th><?php echo $lab_first_month; ?></th>
                            <th><?php echo $select_procedure; ?></th>
                            <th><?php echo $collection_first_month; ?></th>
