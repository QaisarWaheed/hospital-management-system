...
?>
    ...
    ($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['creat($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['created'] != '0000-00-00 00:00:00' ? date_format(date_create($row_token['created']), 'h:i:s A') : '';
            	                $token_branch_tag_name = get_branch_tag_by($row_token['branch_id']);
            	                $docotr_id = $row_token['doctor_id'];
            	                $cash = $row_token['cash'];
            	                $cash_received = $row_token['cash_received'];
...
?>
    ...
    ($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['created'] != '0000-00-00 00:00:00' ? date_format(date_create($row_token['created']), 'h:i:s A') : '';
            	                $token_branch_tag_name = get_branch_tag_by($row_token['branch_id']);
            	                $docotr_id = $row_token['doctor_id'];
            	                $cash = $row_token['cash'];
            	                $cash_received = $row_token['cash_received'];
...
<?php } ?>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpG$row_token['created']), 'h:i:s A') : '';
            	                $token_branch_tag_name = get_branch_tag_by($row_token['branch_id']);
            	                $docotr_id = $row_token['doctor_id'];
            	                $cash = $row_token['cash'];
            	                $cash_received = $row_token['cash_received'];
