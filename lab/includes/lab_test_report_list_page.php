    	        ...
    	        <tbody>
    	            ...
    	            if (count($list_rows) > 0) {
    	                ...
    	                foreach ($list_rows as $row_sample) {
    	                    $s++;
    	                    $added_at = $row_sample['added_at'] ? ($row_sample['added_at'] && $row_sample['added_at'] != '0000-00-00' && $row_sample['added_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sample['added_at']), 'h:i:s A d-m-Y') : '' : '';
...
($row_sample['collected_at'] && $row_sample['collected_at'] != '0000-00-00' && $row_sample['collected_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sample['collected_at']), 'h:i:s A d-m-Y') : '' : '';
    	                    $processed_at = $row_sample['processed_at'] ? date_format(date_create($row_sample['processed_at']), 'h:i:s A d-m-Y') : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
...
function myFunction() { filterTable(1, 'myInput'); }
function myFunctionTestName() { filterTable(2, 'myInputTestName'); }
function($row_sample['collected_at'] && $row_sample['collected_at'] != '0000-00-00' && $row_sample['collected_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sample['collected_at']), 'h:i:s A d-m-Y') : '' : '';
    	                    $processed_at = $row_sample['processed_at'] ? date_format(date_create($row_sample['processed_at']), 'h:i:s A d-m-Y') : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
...
<?php mysqli_close($con); ?>
($row_sample['processed_at'] && $row_sample['processed_at'] != '0000-00-00' && $row_sample['processed_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sampl($row_sample['processed_at'] && $row_sample['processed_at'] != '0000-00-00' && $row_sample['processed_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sample['processed_at']), 'h:i:s A d-m-Y') : '' : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
    	                <td><?php echo htmlspecialchars($row_sample['main_branch_name'], ENT_QUOTES, 'UTF-8') . ' - ' . (int) $row_sample['token_no']; ?>
...
<?php mysqli_close($con); ?>
($row_sample['processed_at'] && $row_sample['processed_at'] != '0000-00-00' && $row_sample['processed_at'] != '0000-00-00 00:00:00' ? date_format(date_create($row_sample['processed_at']), 'h:i:s A d-m-Y') : '' : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
    	                <td><?php echo htmlspecialchars($row_sample['main_branch_name'], ENT_QUOTES, 'UTF-8') . ' - ' . (int) $row_sample['token_no']; ?>
...
<?php mysqli_close($con); ?>
$row_sample['collected_at']), 'h:i:s A d-m-Y') : '' : '';
    	                    $processed_at = $row_sample['processed_at'] ? date_format(date_create($row_sample['processed_at']), 'h:i:s A d-m-Y') : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
...
<?php mysqli_close($con); ?>
$row_sample['processed_at']), 'h:i:s A d-m-Y') : '' : '';
    	            ?>
    	            <tr>
    	                <td><?php echo $s; ?></td>
    	                <td><?php echo htmlspecialchars($row_sample['main_branch_name'], ENT_QUOTES, 'UTF-8') . ' - ' . (int) $row_sample['token_no']; ?>
