                ...
                while($row_token = mysqli_fetch_array($run_token))
                {
                    ...
                    elseif(str_contains($report_test_name, 'PCR'))
                    {
                        ...
                        if(mysqli_num_rows($run_test_report) > 0)
                        {
                            ...
                            echo '<div class = "col-sm-12 text-right" style = "color: black;">RESULT: <strong>NOT DETECTED</strong></div><div class = "col-sm-12 text-right" style = "color: black;">VALUE: '.$lab_test_report_result.'<sub>'.$lab_test_unit_value.'</sub></div></div></div>';
                            echo '</div>';
                        }
                    }
                    else
