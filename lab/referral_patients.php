	            ...
	            <tr class = "nodisplay_print">
	                ...
	                <th>
	                    <form action = "referral_patients.php">
	                        <input onchange="this.form.submit()" class = "form-co($selected_date && $selected_date != '0000-00-00' && $selected_date !=($selected_date && $selected_date != '0000-00-00' && $selected_date != '0000-00-00 00:00:00' ? date_format(date_create($selected_date), 'd-M-Y') : ''; ?></h2>
	        </caption>
	        <thead>
	            <tr class = "nodisplay_print">
	                <th></th>
	                <th>
	                    <form action = "referral_patients.php">
	                        <input onchange="this.form.submit()" class = "form-co($selected_date && $selected_date != '0000-00-00' && $selected_date != '0000-00-00 00:00:00' ? date_format(date_create($selected_date), 'd-M-Y') : ''; ?></h2>
	        </caption>
	        <thead>
	            <tr class = "nodisplay_print">
	                <th></th>
...
if(mysqli_num_rows($run) > 0)
{
    while($row = mysqli_fetch_array($run))
    {
        ...
        $select_token = "SELECT tokans.created, tokans.doctor_id, tokans.branch_id, pa$selected_date), 'd-M-Y') : ''; ?></h2>
	        </caption>
	        <thead>
	            <tr class = "nodisplay_print">
	                <th></th>
...
?>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"($token_create && $token_create != '0000-00-00' && $token_create != '0000-00-00 00:00:00' ? date_format(date_create($token_create),'Y-m-d') : '';
                if($select_date != $searech_date)
                {
                    $INSERT = "INSERT INTO `referral_test_reports`
                    (`referral_test_report_id`, `referral_test_report_date`, `referral_test_report_token_no`, `referral_test_report_doctor_id`, `referral_test_report_status`, `referral_test_report_created`, `user_id`, `b($token_create && $token_create != '0000-00-00' && $token_create != '0000-00-00 00:00:00' ? date_format(date_create($token_create),'Y-m-d') : '';
                if($select_date != $searech_date)
                {
                    $INSERT = "INSERT INTO `referral_test_reports`
                    (`referral_test_report_id`, `referral_test_report_date`, `referral_test_report_token_no`, `referral_test_report_doctor_id`, `referral_test_report_status`, `referral_test_report_created`, `user_id`, `branch_id`) 
