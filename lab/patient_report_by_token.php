                        ...
                        <caption style = "caption-side: top;color: black;">
                            <table class = "table">
                                ...
                                <tr>
                                    ...
                                    <td>Cash</td>
                                    <th><u><?php echo $c($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['creat($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['created'] != '0000-00-00 00:00:00' ? date_format(date_create($row_token['created']), 'h:i:s A') : '';
            	                $token_branch_tag_name = get_branch_tag_by($row_token['branch_id']);
            	                $docotr_id = $row_token['doctor_id'];
            	                $cash = $row_token['cash'];
            	                $cash_received = $row_token['cash_received'];
                        ...
                        <caption style = "caption-side: top;color: black;">
                            <table class = "table">
                                ...
                                <tr>
                                    ...
                                    <th><u><?php echo $docotr_name; ?></u> / <u><?php echo $token_branch_tag_name; ?></u></th>
                                    <td>Cash</td>
                                    <th><u><?php echo $c($row_token['created'] && $row_token['created'] != '0000-00-00' && $row_token['created'] != '0000-00-00 00:00:00' ? date_format(date_create($row_token['created']), 'h:i:s A') : '';
            	                $token_branch_tag_name = get_branch_tag_by($row_token['branch_id']);
            	                $docotr_id = $row_token['doctor_id'];
            	                $cash = $row_token['cash'];
            	                $cash_received = $row_token['cash_received'];
