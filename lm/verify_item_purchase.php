...
?>
	...
	<title>Verify Item Purchase - <?php echo htmlspecialchars($company_trademark, ENT_QUOTES, 'UTF-8'); ?></title>
</head>
<body class="background_image">
    <div class="row" style="margin: 0px;">
    	...
    	<div class="col-md-10">
    		<h2 style="color: white; margin-top: 40px;">Verify Item Purchase</h2>
