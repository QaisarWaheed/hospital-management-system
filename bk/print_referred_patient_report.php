		...
		<div class="row" style="margin: 0px;">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th>Refer To</th>
		            ($date && $date != '0000-00-00' && $date != '0000-00($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), 'd F Y') : ''; ?> </h6></label>
			</div>
			<table class = "table">
		    <thead>
		        <tr>
		            ...
		            <th>Required Opnion</th>
		            <th>Refer To</th>
		            ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), 'd F Y') : ''; ?> </h6></label>
			</div>
			<table class = "table">
		    <thead>
		        <tr>
...
if(mysqli_num_rows($run_referral_token) > 0)
{
    while($row_referral_token = mysqli_fetch_array($run_referral_token))
    {
        ...
        {
            $referral_patient_status_msg = '<td class = "data$date), 'd F Y') : ''; ?> </h6></label>
			</div>
			<table class = "table">
		    <thead>
		        <tr>
