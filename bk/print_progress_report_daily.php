...
<head>
    ...
    <title>GYNAE PROGRESS <?php echo ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), "d-m-Y") : ''; ?><?php echo get_branch_tag_name_by_id($br_id); ?></title>
<style>
@media print 
{  
    @page 
...
if (count($doctor_ids) > 0) {
    foreach ($doctor_ids as $dr_id) {
        ...
        <tr style = "text-align: center;">
            ...
            <td>'.$gynae_count_system_current-$gynae_count_system_token_c($date && $date != '0000-00-00' && $date != '0000-00($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), "d-m-Y") : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th colspan = "3"></th>
...
if (count($doctor_ids) > 0) {
    foreach ($doctor_ids as $dr_id) {
        ...
        <tr style = "text-align: center;">
            ...
            <td>'.$gynae_count_system_token_current.'</td>
            <td>'.$gynae_count_system_current.'</td>
            <td>'.$gynae_count_system_current-$gynae_count_system_token_c($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), "d-m-Y") : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th colspan = "3"></th>
