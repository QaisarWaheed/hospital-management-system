...
<html>
<head>
    <title><?php echo get_branch_name_by($br_id); ?> <?php echo ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' d F Y') : ''; ?> PROCEDURE PROGRESS REPORT</title>
</head>
<body>
...
if (count($doctor_ids) > 0) {
    ...
    echo '</tbody><tfoot><tr style="text-align($date && $date != '0000-00-00' && $date != '0000-0($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' d F Y') : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th>S#</th>
...
if (count($doctor_ids) > 0) {
    ...
    echo '</tbody><tfoot><tr style="text-align($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' d F Y') : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th>S#</th>
