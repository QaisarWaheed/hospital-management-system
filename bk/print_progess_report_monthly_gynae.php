...
$last_day = ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), 't') : '';
...
<caption>
    ...
    <thea($date && $date != '0000-00-00' && $date != '0000-00-00 ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></title>
</head>
<body>
...
<caption>
    ...
    <thea($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></title>
</head>
<body>
...
if (count($doctor_ids) > 0) {
    ...
    foreach ($doctor_ids as $doctor_id) {
        ...
        echo '<td>' . $cur_tok . '</td><td>' . $cur_gyn . '($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
</caption>
    <thea($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></title>
</head>
<body>
...
if (count($doctor_ids) > 0) {
    ...
    echo '<th>' . $to($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></title>
</head>
<body>
...
if (count($doctor_ids) > 0) {
    ...
    echo '</tbody><tfoot><tr style="text-align: right;"><th colspan="3"></th>';
    echo '<th>' . $to($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th colspan="3"></th>
        ...
        <tr>
            <th>SR #</th><th>ID</th><th>NAME</th>
($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
</caption>
    <thead>
        <tr>
            <th colspan="3"></th>
