...
<html>
<head>
    <title>PRINT RECEPTION PROGRESS REPORT <?php echo get_branch_tag_by($br_id); echo ($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></title>
</head>
<body>
...
if (count($stats) > 0) {
    ...
    foreach ($stats as $doctor => $types) {
        ...
        echo '<td>' . $incentive .($date && $date != '0000-00-00' && $date != '0000-00-($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
    <h5 align="center">PROGRESS REPORT IS GENERATED BY: <i><?php echo htmlspecialchars($bk_name, ENT_QUOTES, 'UTF-8'); ?></i>, AT: <i><?php echo date('H:i:s d-m-Y'); ?></i></h5>
</caption>
    <thead>
        <tr>
...
if (count($stats) > 0) {
    ...
    foreach ($stats as $doctor => $types) {
        ...
        echo '<td>' . $count_emergency . ' -> ' . $emergency . '</td>';
        echo '<td>' . $row_total . '</td>';
        echo '<td>' . $incentive .($date && $date != '0000-00-00' && $date != '0000-00-00 00:00:00' ? date_format(date_create($date), ' F Y') : ''; ?></h3>
    <h5 align="center">PROGRESS REPORT IS GENERATED BY: <i><?php echo htmlspecialchars($bk_name, ENT_QUOTES, 'UTF-8'); ?></i>, AT: <i><?php echo date('H:i:s d-m-Y'); ?></i></h5>
</caption>
    <thead>
        <tr>
...
if (count($stats) > 0) {
    ...
    echo '<th>' . $total_emergency . $date), ' F Y') : ''; ?></h3>
    <h5 align="center">PROGRESS REPORT IS GENERATED BY: <i><?php echo htmlspecialchars($bk_name, ENT_QUOTES, 'UTF-8'); ?></i>, AT: <i><?php echo date('H:i:s d-m-Y'); ?></i></h5>
</caption>
    <thead>
        <tr>
